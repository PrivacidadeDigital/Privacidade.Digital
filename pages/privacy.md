...
Você pode entrar em contato com nosso time através dos métodos descritos na nossa [página "Sobre Nós"]({{ site.production_url }}/sobre/).

## O PrivacyTools tem a mesmo tipo de conduta quanto a coleta de dados?

Não. O PrivacyTools oferece serviços adicionais que nós não oferecemos atualmente, e isso muda drasticamente sua conduta de coleta de dados. Favor, visitar a [página de privacidade do projeto em Inglês](https://www.privacytools.io/privacy/) para saber mais.
